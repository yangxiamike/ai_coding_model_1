...
- 结果: 16/16 通过
- 覆盖: 八表 mock reader、官方字段/分页、canonical preset 一致性、完整面板读取、HFQ、历史股票池、ST/停复牌/涨跌停、无前填、分年构建、稳定 ID、敏感路径脱敏、原子失败清理、不可覆盖、离线可携带读取、纯合成 demo、manifest/schema/分区/文件/SHA256 篡改拒绝
